...
public class map_App {
  public static void main(String[] args) {
    ...
    System.out.println("void state_" + "state0" + "() {");
    ...
    System.out.println("   }");
    System.out.println("   state_" + "state0" + "();");
    System.out.println("}\n");
    ...
    System.out.println("   boolean guard = millis() - time > debounce;");
    System.out.println("   if (digitalRead(" + 9 + ") == " + "HIGH" + " && guard ) {");
    System.out.println("     time = millis(); state_" + "state0" + "(); ");
    System.out.println("   }");
    System.out.println("   state_" + "state2" + "();");
    System.out.println("}\n");


    System.out.println("\nvoid loop() { state_" + "state0" + "(); } // Entering init state\n");
